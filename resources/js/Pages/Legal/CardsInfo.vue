...
const t = computed(() => isAr.value ? {
  ...
  tiers:[
    {name:'Standard',badge:'مجاني',color:'#0EA5E9',feats:['بطاقة افتراضية فورية','Apple Pay و Google Pay','ادفع بأي متجر إلكتروني','حد سحب يومي 75,000 ل.س','إشعارات فورية لكل عملية','تجميد فوري من التطبيق']},
